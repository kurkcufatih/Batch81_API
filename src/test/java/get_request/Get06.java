...
public class Get06 extends RestfulBaseUrl {
    ...
    public void get01() {
        ...
        //3. Yol
        //softAssert class'ini kullanmak icin
        ...
        softAssert.assertEquals(json.getBoolean("depositpaid"), false, "depositepaid hatali");
        ...
        softAssert.assertEquals(json.getString("additionalneeds"), "None", "additional needs hatali");

        //iii) dogrulama islemi sonunda softAssert.assertAll() diyerek
        //yaptigimiz tum dogrulama islemlerinin kontrol edilmesini sagliyoruz.
        //Eger islemin sonunda softAssert.assertAll() kullanmaz isek taleplerimiz hatali olsa bile testimiz pass olacaktır.
